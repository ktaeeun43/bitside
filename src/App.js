  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/page/PolicyManagement" element={<PolicyManagement/>}></Route>
        <Route path="/page/AssetManagement" element={<AssetManagement/>}></Route>
        <Route path="/page/CheckManegent" element={<CheckManegent/>}></Route>
        <Route path="/page/RiskManegent" element={<RiskManegent/>}></Route>
        <Route path="/page/DocumentsManegent" element={<DocumentsManegent/>}></Route>
